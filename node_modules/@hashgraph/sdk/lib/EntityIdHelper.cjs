...
function constructor(props, realm, num) {
  if (typeof props === "number" || props instanceof _long.default) {
    if (realm == null) {
       ...
       * @type {Long}
       */
      num = _long.default.fromValue(props)];
    } else {
      return [_long.default.fromValue(props), _long.default.fromValue(realm), num != null ? _long.default.fromValue(num) : _long.default.ZERO];
    }
  } else {
    return [_long.default.fromValue(props.shard != null ? props.shard : 0), _long.default.fromValue(props.realm != null ? props.realm : 0), _long.default.fromValue(props.num != null ? props.num : 0)];
  }
}
/**
 * @param {string} text
...
function fromString(text) {
  ...
  if (components.length === 1) {
    num = _long.default.fromValue(components[0]);
  } else if (components.length === 3) {
    shard = _long.default.fromValue(components[0]);
    realm = _long.default.fromValue(components[1]);
    num = _long.default.fromValue(components[2]);
  } else {
