...
export default class FileUpdateTransaction extends Transaction {
    ...
    constructor(props?: {
        ...
        keys: KeyList | import("@hashgraph/cryptography").Key[] | undefined;
     ...
     * @returns {?Key[]}
     */
    get keys(): import("@hashgraph/cryptography").Key[] | null;
    /**
     * Set the keys which must sign any transactions modifying this file. Required.
     *
     * All keys must sign to modify the file's contents or keys. No key is required
...
declare namespace proto {
    ...
    type IFileUpdateTransactionBody = import("@hashgraph/proto/lib/proto").proto.IFileUpdateTransactionBody;
}
export {};
